...
Vous devez rendre les exercices `3` et `4` (et `5` en bonus) pour le `15/02 à 23:59 (Heure Française)`. Le rendu se fera via un dépôt Git (https://gitlab.istic.univ-rennes1.fr/) ou GitHub contenant un notebook (`Exercice 3`) et un script python (`Exercice 4`).
